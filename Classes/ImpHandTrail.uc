class ImpHandTrail extends DoomEmitter;

simulated function Tick( float Delta )
{
	LightBrightness = Min(255,LightBrightness+Delta*200.f);
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'ScrnDoom3KF.ImpHandTrail.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'ScrnDoom3KF.ImpHandTrail.SpriteEmitter1'
     ...
     End Object
     Emitters(2)=BeamEmitter'ScrnDoom3KF.ImpHandTrail.BeamEmitter0'
