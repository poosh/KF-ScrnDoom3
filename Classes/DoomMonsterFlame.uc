// TODO: Combine with ScrnMonsterFlame and move to ScrnShared
class DoomMonsterFlame extends KFMonsterFlame;
...
function Timer()
{
    ...
    foreach DynamicActors(class'DoomMonsterFlame', Other) {
